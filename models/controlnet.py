...
from models.modules import BAEM
...
class ControlNetModel(ModelMixin, ConfigMixin, FromOriginalControlnetMixin):
    ...
    def __init__(
        ...
        # 优化条件embedding
        # stand
        self.controlnet_cond_embeddings = BAEM(
            img_channel=3,
            out_chanel=block_out_channels[0],
            width=32,
            enc_blk_nums=[1,1,1],
            middle_blk_num=1,
            dec_blk_nums=[1,1,1],
    ...
    def forward(
        ...
        controlnet_cond_emb, restore_out = self.controlnet_cond_embeddings(controlnet_cond, moe_weight)

        sample = sample + controlnet_cond_emb
        ...
        if not return_dict:
            return (restore_out, down_block_res_samples, mid_block_res_sample)

        return ControlNetOutput(
            restore_out=restore_out, down_block_res_samples=down_block_res_samples, mid_block_res_sample=mid_block_res_sample
        )
